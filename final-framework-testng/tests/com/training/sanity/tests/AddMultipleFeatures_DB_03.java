/***************************************************************
 * Objective : To Verify whether application allows admin to Add multiple New Feature in the application & added feature details get displayed in database
 * Author : Sanjog Bal
 * 
 **************************************************************/
/***************************************************************
...
public class AddMultipleFeatures_DB_03 {
	...
	public void addFeatures(String name, String slug, String description) throws InterruptedException{
		...
		screenShot.captureScreenShot("AddMultipleFeaturesDB");
	}
